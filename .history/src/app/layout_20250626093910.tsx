...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "ຮ້ານຂາຍອາຫານທະເລ - ໜ້າທຳອິດ | Seafood Shop",
    description: "ສັ່ງຊື້ອາຫານທະເລ ລາຄາຖືກ ສົ່ງໄວ ທັນໃຈ ສາມາດໂອນເງີນ ປາຍທາງໄດ້",
...
export default function RootLayout({
  ...
  return (
    <html lang="lo" className={notoSansLao.variable}>
      <head>
        <link rel="apple-touch-icon" href="/images/web-app-for-apple.png" />

        <link rel="manifest" href="/manifest.json" />
          <link rel="preload" href="/fonts/NotoSansLao-Regular.woff2" as="font" type="font/woff2" crossOrigin="anonymous">
<link rel="preload" href="/fonts/NotoSansLao-Bold.woff2" as="font" type="font/woff2" crossOrigin="anonymous">
