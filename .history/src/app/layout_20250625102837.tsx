...
export const metadata: Metadata = {
  ...
  description:
    "ຮ້ານຂາຍອາຫານທະເລອອນໄລ ໜ້າທຳອິດ ລວມອາຫານທະເລຫຼາກຫຼາຍ ເຊັ່ນ ປາ, ປູ, ກຸ້ງ ແລະ ອາຫານທະເລອື່ນໆ ສາມາດສັ່ງຊື້ໃນເວັບໄຊໄດ້ ມີບໍລິການສົ່ງໄປເຖີງ ສາມາດເຮັດ ການໂອນເງິນ",
  keywords:
