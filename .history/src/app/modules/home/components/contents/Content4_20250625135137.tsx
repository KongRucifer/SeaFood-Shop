...
export default async function Content4() {
  return (
    <div className="relative w-full h-160 r overflow-hidden mb-10">
      ...
      />
      <div className="relative z-10 flex items-center justify-center gap-10 h-full text-4xl font-bold text-gray-700">
        <div>
          ...
          <h4 className="text-md">Dive In & Explore</h4>
          <h5>
          ...
          <h4>Pro Tip: Not sure what to try first?</h4>
