  ...
  return (
    <div className="relative w-full h-[40rem] overflow-hidden mb-10">
      <img
        ...
        className="w-full h-68 object-cover rounded-md transition-transform duration-500 ease-in-out group-hover:scale-105 transform-gpu"
      />

      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center h-full text-center px-4 md:px-10 text-gray-800 bg-black/30 backdrop-blur-sm">
        {[...Array(3)].map((_, index) => (
          <div
            key={index}
            className="max-w-sm bg-white/80 rounded-xl p-6 m-4 shadow-lg"
          >
