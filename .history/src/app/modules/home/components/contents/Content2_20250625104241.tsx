export default function Content2() {
  return (
    <div className="container mx-auto py-8 mb-10">
      ...
      <div className="flex grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 overflow-x-auto space-x-4 pb-4">
        {/* Card 1 */}
        <div className="min-w-[200px] bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105 flex flex-col">
          <img
            src="/images/kabpum.jpeg"
            alt="Seafood Dish 1"
            className="w-full h-48 object-cover rounded-md transition-transform duration-500 ease-in-out"
          />
          ...
          <div className="flex justify-center mt-4">
            <button className="w-full bg-green-500 hover:bg-green-700 text-white p-2 rounded shadow-md transition-transform duration-300 hover:scale-105">
              Add To Cart
            </button>
          </div>
        </div>
