export default function Page() {
  return (
    <div className="container mx-auto py-8">
      ...
      <div>
      <h1 className="text-lg font-bold mb-6 text-gray-500 flex items-center "><img src="/images/firstCheer.png" alt="no image" className="w-7" />100% satisfaction guarantee</h1>
      </div>
        </div>
