      ...
      <div className="flex overflow-x-auto space-x-4 pb-4">
        ...
        <div className="min-w-[200px] flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
          ...
          <div className="flex justify-center mt-4">
            <button className="min-w-[200px] flex-shrink-0 bg-white rounded-lg shadow-lg p-5 cursor-pointer bg-green-600 text-white transform transition duration-300 hover:scale-105">
              Add To Cart
            </button>
          </div>
        </div>
        ...
        <div className="min-w-[200px] flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
          ...
          <div className="mt-2">
            ...
            <div className="flex justify-center mt-4">
            <button className="min-w-[200px] flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
              Add To Cart
            </button>
          </div>
        </div>
