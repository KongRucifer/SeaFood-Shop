    ...
    <footer className="bg-black dark:bg-gray-900">
      <div className="max-w-screen-xl mx-auto container pt-4 pb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 text-white mb-20 mt-15">
           ...
           <div>
            <p className="text-lg">Opened in 1822, Lak 52 City’s Fulton Fish Market is one of </p>
            <p className="text-lg">the oldest fish markets in the Loas. We offer the world's</p>
            <p className="text-lg">largest assortment of seafood online. Order fresh, healthy and delicious </p>
            <p className="text-lg">seafood direct from the market with next-day delivery to your door.</p>
           </div>
           </div>
           <div>
