      ...
      <div className="max-w-screen-xl mx-auto container pt-4 pb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 text-white mb-20 mt-15">
           ...
           <div>      
            ...
            <p className="text-md">the oldest fish markets in Laos. We offer the world&apos;s</p>
            <p className="text-md">largest assortment of seafood online. Order fresh, healthy, and delicious</p>
            <p className="text-md"> seafood directly from the market with next-day delivery to your door.</p>
           </div>
           </div>
           <div>
           ...
           <div className="-mt-10">
             <div className="mb-2 text-green-500 flex items-center gap-1"><Image  src="/images/star.png" alt="no image star" fill className="-mt-5" /><h3>SEAFOOD SHOP</h3></div>
           <div>
             <h3 className="mb-5 text-green-500">Follow us</h3>
              <ul className="flex space-x-4">
                <li>
                  <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                    <Image  src="/images/facebook.png" fill alt="Facebook" className="w-6 h-6" />
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                    <Image  src="/images/instagram.png" fill alt="Instagram" className="w-6 h-6" />
                  </a>
                </li>
                <li>
                  <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                    <Image  src="/images/twitter.png" fill alt="Twitter" className="w-6 h-6" />
                  </a>
                </li>
               </ul>
           </div>
