    ...
    <footer className="bg-black dark:bg-gray-900">
      <div className="max-w-screen-xl mx-auto container pt-4 pb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 text-white mb-20 mt-15">
           ...
           <div>
            <p className="text-md">
  Opened in 1822, Lak 52 City's Fulton Fish Market is one of the oldest fish markets in Laos. We offer the world&apos;s largest assortment of seafood online. Order fresh, healthy, and delicious seafood directly from the market with next-day delivery to your door.
</p>
           ...
           <div>
            <ul>
              <li className="cursor-pointer hover:text-gray-300 transition">About Shop</li>
           ...
           <div className="-mt-10">
             <div className="mb-2 text-green-500 flex items-center gap-1"><Image  src="/images/star.png" alt="no image star" className="-mt-5" /><h3>SEAFOOD SHOP</h3></div>
           <div>
             <h3 className="mb-5 text-green-500">Follow us</h3>
              <ul className="flex space-x-4">
                <li>
                  <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                    <Image  src="/images/facebook.png" alt="Facebook" className="w-6 h-6" />
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                    <Image  src="/images/twitter.png" alt="Twitter" className="w-6 h-6" />
                  </a>
                </li>
               </ul>
           </div>
