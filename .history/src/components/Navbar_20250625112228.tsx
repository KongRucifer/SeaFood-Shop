    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900 shadow-md fixed top-0 left-0 z-50 w-full">
      ...
      <div className=" flex flex-wrap items-center justify-between  p-4">
        ...
        <div className="flex justify-center items-center md:order-2 gap-10">
          ...
          <Link href="/" className="-pb-1 border-b-2 border-transparent hover:border-green-500 transition">Privacy Policy</Link>
          <Link href="/" className="-pb-1 border-b-2 border-transparent hover:border-green-500 transition">Terms of Service</Link>
          <li>Contact Us</li>
