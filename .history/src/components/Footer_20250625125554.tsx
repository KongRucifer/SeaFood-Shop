...
export default function Footer() {
  return (
    <footer className="bg-black dark:bg-gray-900">
      <div className="max-w-screen-xl mx-auto container pt-4 pb-4 sm:text-center">
        <div>
        ...
        <div className="flex flex-col  md:flex-row justify-between  items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 text-white mb-20 mt-15">
           ...
           <div>
             <h3 className="mb-5 text-green-500 sm:mb-10 md:mb-10">LEARN ABOUT US</h3>
           <div>
            <ul>
           ...
           <div className="xl:-mt-13 lg:-mt-13 sm:mt-10 md:-mt-13  sm:text-center  ">
           ...
           <div>
             <h3 className="mb-5 text-green-500 sm:text-center">Follow us</h3>
              <ul className="flex space-x-4 sm:text-center">
                <li>
