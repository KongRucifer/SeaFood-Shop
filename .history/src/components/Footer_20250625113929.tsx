    ...
    <footer className="bg-black dark:bg-gray-900">
      <div className="max-w-screen-xl mx-auto container pt-4 pb-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-8 text-white mb-20 mt-15">
           ...
           <div>
            <h4>Opened in 1822, Lak 52 City’s Fulton Fish Market is one of </h4>
            <h4>the oldest fish markets in the Loas. We offer the world's</h4>
            <h4>largest assortment of seafood online. Order fresh, healthy and delicious </h4>
            <h4>seafood direct from the market with next-day delivery to your door.</h4>
           </div>
           </div>
           <div>
           ...
           <div>
             <div className="mb-2 text-green-500 flex items-center gap-1"><img src="/images/star.png" alt="no image star" className="-mt-" /><h3>SEAFOOD SHOP</h3></div>
           <div>
