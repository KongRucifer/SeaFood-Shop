  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="flex overflow-x-auto space-x-4 pb-4">
        {/* Card 1 */}
        <div className="w-75 flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
          <div>
            <img
        ...
        <div className="w-75 flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
          ...
          <div className="w-">
            <h4 className="font-semibold text-gray-800">
              Wild Alaska Salmon Bundle, Small
            </h4>
        ...
        <div className="75 flex-shrink-0 bg-white rounded-lg shadow-lg p-5 transform transition duration-300 hover:scale-105">
          <div>
            <img
